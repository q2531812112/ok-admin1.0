...
<div class="ok-body">
    ...
    <form class="layui-form ok-form" lay-filter="filter">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" id="password" name="accountPassword" placeholder="请输入密码,留空表示不修改原来的密码" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    ...
    layui.use(["element", "form", "laydate", "okLayer", "okUtils"], function () {
        ...
        form.on("submit(edit)", function (data) {
            okUtils.ajax(okUtils.mockApi.user.update, "post", data.field).done(function (response) {
