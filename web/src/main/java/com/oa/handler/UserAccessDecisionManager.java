 ...
 * 有了权限资源(MyFilterInvocationSecurityMetadataSource)，知道了当前访问的url需要的具体权限，
 * 接下来就是决策当前的访问是否能通过权限验证了
 * MyAccessDecisionManager 自定义权限决策管理器
 * @author: MagicXianyu
 * @date: 2020-06-16 15:15
 */
@Component
public class UserAccessDecisionManager implements AccessDecisionManager {
    public UserAccessDecisionManager(){
        System.out.println("UserAccessDecisionManager  >>>  Loding......");
    }
...
//            System.out.println("当前请求需要的权限为 ::: "+needRole);
            //当前用户所具有的权限
            Collection<? extends GrantedAuthority> authorities = authentication.getAuthorities();
            for (GrantedAuthority authority : authorities) {
//                System.out.println("当前登录的用户所拥有的权限 ::: "+authority.getAuthority());
